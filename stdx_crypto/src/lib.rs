//! `stdx_crypto` is a cross-platform, secure, easy to use, and hard to misuse cryptographic library in Rust,
//! using [libsodium](https://github.com/jedisct1/libsodium) as backend.
//!
//! Repository: [https://github.com/skerkour/stdx](https://github.com/skerkour/stdx)
//!
//! ## Usage
//!
//! ```toml
//! [dependencies]
//! stdx_crypto = { version = "0.1", git = "https://github.com/skerkour/stdx" }
//! ```
//!
//! See [https://github.com/skerkour/stdx/tree/dev/examples](https://github.com/skerkour/stdx/tree/dev/examples)
