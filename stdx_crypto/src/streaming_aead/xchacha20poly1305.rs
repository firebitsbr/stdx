...
use libsodium_sys::{
    ...
    crypto_secretstream_xchacha20poly1305_init_push, crypto_secretstream_xchacha20poly1305_messagebytes_max,
...
mod test {
    ...
    fn encrypt_decrypt_with_recycled_vec() {
        ...
        encrypt_stream
            ...
            .unwrap();
        let t1 = decrypt_stream.decrypt_to_vec(&c_buf, None, &mut m_buf).unwrap();
        assert_eq!(t1, Tag::Message);
        ...
        encrypt_stream
            ...
            .unwrap();
        let t2 = decrypt_stream.decrypt_to_vec(&c_buf, None, &mut m_buf).unwrap();
        ...
        encrypt_stream
            ...
            .unwrap();
        let t3 = decrypt_stream.decrypt_to_vec(&c_buf, None, &mut m_buf).unwrap();
        assert_eq!(t3, Tag::Final);
