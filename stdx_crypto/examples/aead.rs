use std::str;
use stdx_crypto::{aead::xchacha20poly1305_ietf, zeroize::Zeroize, Error};
...
fn main() -> Result<(), Error> {
    ...
    let plaintext2 =
        xchacha20poly1305_ietf::decrypt(&ciphertext, None, &nonce, &key).expect("Error decrypting ciphertext");
