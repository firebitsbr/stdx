...
extern "C" {
    pub fn sodium_set_misuse_handler(handler: ::core::option::Option<unsafe extern "C" fn()>) -> libc::c_int;
}
extern "C" {
...
fn bindgen_test_layout_crypto_aead_aes256gcm_state_() {
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<crypto_aead_aes256gcm_state_>())).opaque as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
...
extern "C" {
    pub fn crypto_hash_sha512_final(state: *mut crypto_hash_sha512_state, out: *mut libc::c_uchar) -> libc::c_int;
}
extern "C" {
...
fn bindgen_test_layout_crypto_auth_hmacsha512_state() {
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<crypto_auth_hmacsha512_state>())).ictx as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<crypto_auth_hmacsha512_state>())).octx as *const _ as usize },
        208usize,
        concat!(
            "Offset of field: ",
            stringify!(crypto_auth_hmacsha512_state),
...
extern "C" {
    pub fn crypto_hash_sha256_final(state: *mut crypto_hash_sha256_state, out: *mut libc::c_uchar) -> libc::c_int;
}
extern "C" {
...
fn bindgen_test_layout_crypto_auth_hmacsha256_state() {
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<crypto_auth_hmacsha256_state>())).ictx as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<crypto_auth_hmacsha256_state>())).octx as *const _ as usize },
        104usize,
        concat!(
            "Offset of field: ",
            stringify!(crypto_auth_hmacsha256_state),
...
extern "C" {
    pub fn crypto_box_curve25519xsalsa20poly1305_keypair(pk: *mut libc::c_uchar, sk: *mut libc::c_uchar)
        -> libc::c_int;
}
extern "C" {
...
fn bindgen_test_layout_crypto_generichash_blake2b_state() {
    ...
    assert_eq!(
        ...
        64usize,
        concat!("Alignment of ", stringify!(crypto_generichash_blake2b_state))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<crypto_generichash_blake2b_state>())).opaque as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
...
extern "C" {
    pub fn crypto_hash(out: *mut libc::c_uchar, in_: *const libc::c_uchar, inlen: libc::c_ulonglong) -> libc::c_int;
}
extern "C" {
...
fn bindgen_test_layout_crypto_onetimeauth_poly1305_state() {
    ...
    assert_eq!(
        ...
        16usize,
        concat!("Alignment of ", stringify!(crypto_onetimeauth_poly1305_state))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<crypto_onetimeauth_poly1305_state>())).opaque as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
...
extern "C" {
    pub fn crypto_onetimeauth_init(state: *mut crypto_onetimeauth_state, key: *const libc::c_uchar) -> libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn crypto_onetimeauth_final(state: *mut crypto_onetimeauth_state, out: *mut libc::c_uchar) -> libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn crypto_scalarmult_curve25519_base(q: *mut libc::c_uchar, n: *const libc::c_uchar) -> libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn crypto_scalarmult(q: *mut libc::c_uchar, n: *const libc::c_uchar, p: *const libc::c_uchar) -> libc::c_int;
}
extern "C" {
...
fn bindgen_test_layout_crypto_secretstream_xchacha20poly1305_state() {
    assert_eq!(
        ...
        52usize,
        concat!("Size of: ", stringify!(crypto_secretstream_xchacha20poly1305_state))
    );
    assert_eq!(
        ::core::mem::align_of::<crypto_secretstream_xchacha20poly1305_state>(),
        1usize,
        concat!("Alignment of ", stringify!(crypto_secretstream_xchacha20poly1305_state))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<crypto_secretstream_xchacha20poly1305_state>())).k as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<crypto_secretstream_xchacha20poly1305_state>())).nonce as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(crypto_secretstream_xchacha20poly1305_state),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<crypto_secretstream_xchacha20poly1305_state>()))._pad as *const _ as usize },
        44usize,
        concat!(
            "Offset of field: ",
            stringify!(crypto_secretstream_xchacha20poly1305_state),
...
extern "C" {
    pub fn crypto_secretstream_xchacha20poly1305_rekey(state: *mut crypto_secretstream_xchacha20poly1305_state);
}
extern "C" {
...
extern "C" {
    pub fn crypto_sign_ed25519_keypair(pk: *mut libc::c_uchar, sk: *mut libc::c_uchar) -> libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn crypto_sign_ed25519_sk_to_seed(seed: *mut libc::c_uchar, sk: *const libc::c_uchar) -> libc::c_int;
}
extern "C" {
    pub fn crypto_sign_ed25519_sk_to_pk(pk: *mut libc::c_uchar, sk: *const libc::c_uchar) -> libc::c_int;
}
extern "C" {
...
fn bindgen_test_layout_randombytes_implementation() {
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<randombytes_implementation>())).implementation_name as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<randombytes_implementation>())).random as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(randombytes_implementation),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<randombytes_implementation>())).stir as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(randombytes_implementation),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<randombytes_implementation>())).uniform as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(randombytes_implementation),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<randombytes_implementation>())).close as *const _ as usize },
        40usize,
        concat!(
            "Offset of field: ",
            stringify!(randombytes_implementation),
...
extern "C" {
    pub fn randombytes_buf_deterministic(buf: *mut libc::c_void, size: usize, seed: *const libc::c_uchar);
}
extern "C" {
...
extern "C" {
    pub fn sodium_memcmp(b1_: *const libc::c_void, b2_: *const libc::c_void, len: usize) -> libc::c_int;
}
extern "C" {
    pub fn sodium_compare(b1_: *const libc::c_uchar, b2_: *const libc::c_uchar, len: usize) -> libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn crypto_core_ed25519_from_uniform(p: *mut libc::c_uchar, r: *const libc::c_uchar) -> libc::c_int;
}
extern "C" {
    pub fn crypto_core_ed25519_from_hash(p: *mut libc::c_uchar, h: *const libc::c_uchar) -> libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn crypto_core_ed25519_scalar_invert(recip: *mut libc::c_uchar, s: *const libc::c_uchar) -> libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn crypto_core_ed25519_scalar_add(z: *mut libc::c_uchar, x: *const libc::c_uchar, y: *const libc::c_uchar);
}
extern "C" {
    pub fn crypto_core_ed25519_scalar_sub(z: *mut libc::c_uchar, x: *const libc::c_uchar, y: *const libc::c_uchar);
}
extern "C" {
    pub fn crypto_core_ed25519_scalar_mul(z: *mut libc::c_uchar, x: *const libc::c_uchar, y: *const libc::c_uchar);
}
extern "C" {
...
extern "C" {
    pub fn crypto_core_ristretto255_from_hash(p: *mut libc::c_uchar, r: *const libc::c_uchar) -> libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn crypto_core_ristretto255_scalar_invert(recip: *mut libc::c_uchar, s: *const libc::c_uchar) -> libc::c_int;
}
extern "C" {
    pub fn crypto_core_ristretto255_scalar_negate(neg: *mut libc::c_uchar, s: *const libc::c_uchar);
}
extern "C" {
    pub fn crypto_core_ristretto255_scalar_complement(comp: *mut libc::c_uchar, s: *const libc::c_uchar);
}
extern "C" {
    pub fn crypto_core_ristretto255_scalar_add(z: *mut libc::c_uchar, x: *const libc::c_uchar, y: *const libc::c_uchar);
}
extern "C" {
    pub fn crypto_core_ristretto255_scalar_sub(z: *mut libc::c_uchar, x: *const libc::c_uchar, y: *const libc::c_uchar);
}
extern "C" {
    pub fn crypto_core_ristretto255_scalar_mul(z: *mut libc::c_uchar, x: *const libc::c_uchar, y: *const libc::c_uchar);
}
extern "C" {
...
extern "C" {
    pub fn crypto_scalarmult_ed25519_base(q: *mut libc::c_uchar, n: *const libc::c_uchar) -> libc::c_int;
}
extern "C" {
    pub fn crypto_scalarmult_ed25519_base_noclamp(q: *mut libc::c_uchar, n: *const libc::c_uchar) -> libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn crypto_scalarmult_ristretto255_base(q: *mut libc::c_uchar, n: *const libc::c_uchar) -> libc::c_int;
}
extern "C" {
