...
fn test_crypto_core_salsa2012_outputbytes() {
    assert!(unsafe { crypto_core_salsa2012_outputbytes() } == crypto_core_salsa2012_OUTPUTBYTES as usize)
}

#[test]
fn test_crypto_core_salsa2012_inputbytes() {
    assert!(unsafe { crypto_core_salsa2012_inputbytes() } == crypto_core_salsa2012_INPUTBYTES as usize)
}
...
fn test_crypto_core_salsa2012_constbytes() {
    assert!(unsafe { crypto_core_salsa2012_constbytes() } == crypto_core_salsa2012_CONSTBYTES as usize)
}
