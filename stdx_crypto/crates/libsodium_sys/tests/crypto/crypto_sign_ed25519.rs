...
fn test_crypto_sign_ed25519_publickeybytes() {
    assert!(unsafe { crypto_sign_ed25519_publickeybytes() } == crypto_sign_ed25519_PUBLICKEYBYTES as usize)
}

#[test]
fn test_crypto_sign_ed25519_secretkeybytes() {
    assert!(unsafe { crypto_sign_ed25519_secretkeybytes() } == crypto_sign_ed25519_SECRETKEYBYTES as usize)
}
