...
fn test_crypto_secretbox_xsalsa20poly1305_keybytes() {
    assert!(
        unsafe { crypto_secretbox_xsalsa20poly1305_keybytes() } == crypto_secretbox_xsalsa20poly1305_KEYBYTES as usize
    )
}
...
fn test_crypto_secretbox_xsalsa20poly1305_macbytes() {
    assert!(
        unsafe { crypto_secretbox_xsalsa20poly1305_macbytes() } == crypto_secretbox_xsalsa20poly1305_MACBYTES as usize
    )
}
